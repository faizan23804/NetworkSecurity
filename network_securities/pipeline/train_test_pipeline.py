...
from network_securities.entity.config_entity import(
...
from network_securities.entity.artifact_entity import (
...
from network_securities.constant.training_pipeline import TRAINING_BUCKET_NAME,SAVED_MODEL_DIR
from network_securities.cloud.s3_syncer import S3Sync


class Train_Test_Pipeline:
    def __init__(self):
